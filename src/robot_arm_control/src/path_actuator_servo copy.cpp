...
float servo0back,servo1back,servo2back,servo3back;
...
int main(int argc, char **argv)
{
    ...
    while(ros::ok())
    {
        ...
        servo0back = servo0.queryRawAngle();
		servo1back = servo1.queryRawAngle();
		servo2back = servo2.queryRawAngle();
		servo3back = servo3.queryRawAngle();
        cout << "********romachen**data************"<<endl;
        cout << "*******Servo0 Angle: " <<  servo0back <<"***" <<endl;
		cout << "*******Servo1 Angle: " <<  servo1back <<"***" <<endl;
		cout << "*******Servo2 Angle: " <<  servo2back <<"***" <<endl;
		cout << "*******Servo3 Angle: " <<  servo3back <<"***" <<endl;
        cout << "**********************************"<<endl;
        ros::spinOnce();
        naptime.sleep();
    }
