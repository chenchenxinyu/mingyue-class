//send data to a new node ,look the state if right,the best is it can send the data to gazebo or hardware 
#include <ros/ros.h>
#include <iostream>
#include <string>
...
bool clientAngleCallback(robot_arm_message::robarm_gazeboRequest &request, robot_arm_message::robarm_gazeboResponse &response)
{
  ...
  cout<<command0.data<<endl;
  cout<<command1.data<<endl;
  cout<<command2.data<<endl;
  cout<<command3.data<<endl;
